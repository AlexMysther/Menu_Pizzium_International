...
data/
  ...
  i18n/
    ...
    en.json, de.json, nl.json, fr.json, es.json, pt.json
    pl.json, ru.json, uk.json, zh.json, ja.json, ko.json
    tr.json, ar.json, he.json
```
